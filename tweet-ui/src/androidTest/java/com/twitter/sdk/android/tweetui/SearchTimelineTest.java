...
public class SearchTimelineTest extends TweetUiTestCase {
    ...
    private static final Date TEST_UNTIL = Calendar.getInstance().set(2012, 8, 20).getTime();
    ...
    public void testFilterRetweets() {
        final SearchTimeline timeline = new SearchTimeline(tweetUi, TEST_QUERY, null, null, null, null);
